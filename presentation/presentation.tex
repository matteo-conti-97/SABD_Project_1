...
\subtitle{Corso di Sistemi e Architetture per Big Data}

\author{Luca Falasca \and Matteo Conti}

\institute[UFG] % (optional)
{
  Batch processing - Progetto 1
}
\date{2024}
...
\begin{frame}{Example on using image}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=.9\textwidth]{../report/res/grafana_dashboard.png}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \begin{subfigure}{0.2\textwidth}
            \centering
            \includegraphics[height=1cm]{lib/logos/LOGO-ATENEO_BIANCO_20230308.png}
        \end{subfigure}%
        \qquad 
